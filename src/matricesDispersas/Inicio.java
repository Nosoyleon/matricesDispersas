		...
		do {
			...
			case INSERT_DATO: {
				...
				if (!cordExist) {
					...
					int maxRows = mainTripleta.getRowsCount() - 1 > insertRow ? mainTripleta.getRowsCount()
							: insertRow + 1;
					int maxCols = mainTripleta.getColsCount() - 1 > insertCol ? mainTripleta.getColsCount()
							: insertCol + 1;
